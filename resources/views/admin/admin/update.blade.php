              ...
              <form  action="{{ route('admin.update',$edit->id) }}" method="post" >
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name',$edit->id) }}" class="form-control @error('name')
                      is-invalid
                    ...
                    <input type="email" value="{{ old('email',$edit->email) }}" name="email" class="form-control  @error('email')
                      is-invalid
