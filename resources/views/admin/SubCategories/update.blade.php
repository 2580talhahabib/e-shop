          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form  action="{{ route('subcategory.update',$edit->id) }}" method="POST" >
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    @foreach ($categories as $category)
                      <option value="{{ $category->id }}" {{ isset($edit->category_id) ? 'selected' : ''}}>{{ $category->name}}</option>
                    @endforeach 
                    </select>
                ...
                <input type="text" name="slug" value="{{ old('slug',$edit->slug) }}" class="form-control @error('slug') is-invalid @enderror">
                    @error('slug')
