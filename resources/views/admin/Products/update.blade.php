          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form  action="{{ route('category.update',$edit->id) }}" method="POST" >
                ...
                <input type="text" name="slug" value="{{ old('slug',$edit->name) }}" class="form-control @error('slug') is-invalid @enderror">
                    @error('slug')
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title',$edit->name) }}" class="form-control ">
                  </div>
                    <div class="form-group">
                    <label for="exampleInputEmail1">Meta Descripation</label>
                   <textarea name="meta_descripation"  class="form-control" id="meta_descripation" cols="130" rows="5">     {{ isset($edit) ? $edit->meta_descripation : '' }}</textarea>
                  </div>
                    <div class="form-group">
